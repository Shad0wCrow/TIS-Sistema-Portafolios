 ...
 *
 * HU-8: Se agrega el campo "grado" a todos los registros de educación formal.
 * Los registros que representan cursos (area_estudio='curso') se mantienen
 * en CatalogoSeeder / otros seeders y NO incluyen grado (NULL).
 */
class CurriculumSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('certificacion')->insert([
            ['usuario_id' => 1, 'entidad_emisora_id' => 1,  'nombre' => 'Meta Back-End Developer Professional Certificate', 'fecha_obtencion' => '2022-06-01', 'fecha_expiracion' => null,         'url_certificado' => 'https://coursera.org/verify/abc001', 'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 1, 'entidad_emisora_id' => 3,  'nombre' => 'Google Professional Cloud Developer',             'fecha_obtencion' => '2023-02-15', 'fecha_expiracion' => '2025-02-15', 'url_certificado' => 'https://google.com/cert/abc002',    'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 2, 'entidad_emisora_id' => 2,  'nombre' => 'Node.js: The Complete Guide (MVC, REST APIs, GraphQL)', 'fecha_obtencion' => '2021-04-10', 'fecha_expiracion' => null,    'url_certificado' => 'https://udemy.com/cert/abc003',     'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 2, 'entidad_emisora_id' => 7,  'nombre' => 'Back End Development and APIs',                   'fecha_obtencion' => '2022-09-20', 'fecha_expiracion' => null,         'url_certificado' => 'https://freecodecamp.org/cert/abc004','visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 3, 'entidad_emisora_id' => 9,  'nombre' => 'UX Design Fundamentals',                          'fecha_obtencion' => '2022-01-15', 'fecha_expiracion' => null,         'url_certificado' => 'https://linkedin.com/cert/abc005',  'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 3, 'entidad_emisora_id' => 3,  'nombre' => 'Google UX Design Professional Certificate',       'fecha_obtencion' => '2023-05-10', 'fecha_expiracion' => null,         'url_certificado' => 'https://coursera.org/verify/abc006', 'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 4, 'entidad_emisora_id' => 1,  'nombre' => 'IBM Data Science Professional Certificate',       'fecha_obtencion' => '2021-09-01', 'fecha_expiracion' => null,         'url_certificado' => 'https://coursera.org/verify/abc007', 'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 4, 'entidad_emisora_id' => 5,  'nombre' => 'AWS Certified Data Analytics – Specialty',       'fecha_obtencion' => '2022-11-20', 'fecha_expiracion' => '2025-11-20', 'url_certificado' => 'https://aws.amazon.com/cert/abc008', 'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 5, 'entidad_emisora_id' => 4,  'nombre' => 'Meta React Native Specialist',                   'fecha_obtencion' => '2022-07-01', 'fecha_expiracion' => null,         'url_certificado' => 'https://developers.facebook.com/cert/abc009','visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 5, 'entidad_emisora_id' => 3,  'nombre' => 'Google Associate Android Developer',             'fecha_obtencion' => '2023-01-12', 'fecha_expiracion' => '2026-01-12', 'url_certificado' => 'https://google.com/cert/abc010',    'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 6, 'entidad_emisora_id' => 5,  'nombre' => 'AWS Certified Solutions Architect – Associate',  'fecha_obtencion' => '2021-03-15', 'fecha_expiracion' => '2024-03-15', 'url_certificado' => 'https://aws.amazon.com/cert/abc011', 'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 6, 'entidad_emisora_id' => 5,  'nombre' => 'AWS Certified DevOps Engineer – Professional',  'fecha_obtencion' => '2022-08-10', 'fecha_expiracion' => '2025-08-10', 'url_certificado' => 'https://aws.amazon.com/cert/abc012', 'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 6, 'entidad_emisora_id' => 6,  'nombre' => 'Microsoft Certified: Azure Administrator',       'fecha_obtencion' => '2023-04-05', 'fecha_expiracion' => '2025-04-05', 'url_certificado' => 'https://learn.microsoft.com/cert/abc013','visibilidad' => 'publico', 'eliminado' => false, ],
        ]);

        // ─── Logros ───────────────────────────────────────────────────
        DB::table('logro')->insert([
            ['usuario_id' => 1, 'entidad_emisora_id' => 5,    'titulo' => '1er lugar – Hackathon TechBolivia 2023',        'descripcion' => 'Primer puesto en la categoría de soluciones sostenibles construyendo una app de gestión de residuos.',   'fecha_obtencion' => '2023-10-15', 'url_credencial' => null,                               'identificador' => 'HTB2023-01', 'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 1, 'entidad_emisora_id' => null,  'titulo' => 'Speaker – DevConf Bolivia 2024',              'descripcion' => 'Charla sobre "Migración de monolitos a microservicios sin dolor" con más de 200 asistentes.',           'fecha_obtencion' => '2024-03-20', 'url_credencial' => 'https://devconf.bo/speakers/ana',  'identificador' => null,         'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 2, 'entidad_emisora_id' => null,  'titulo' => 'Top Contributor – Laravel Bolivia Community', 'descripcion' => 'Reconocido como uno de los 5 contribuidores más activos de la comunidad Laravel en Bolivia.',           'fecha_obtencion' => '2023-06-01', 'url_credencial' => null,                               'identificador' => null,         'visibilidad' => 'publico', 'eliminado' => false, ],
            ...
            ['usuario_id' => 4, 'entidad_emisora_id' => null,  'titulo' => 'Kaggle Competition – Top 5%',                 'descripcion' => 'Clasificó en el top 5% en la competencia "House Prices: Advanced Regression Techniques".',              'fecha_obtencion' => '2022-12-01', 'url_credencial' => 'https://kaggle.com/c/house-prices', 'identificador' => null,        'visibilidad' => 'publico', 'eliminado' => false, ],
            ['usuario_id' => 5, 'entidad_emisora_id' => null,  'titulo' => 'App del Mes – Play Store Colombia',           'descripcion' => 'La app HealthTrack desarrollada para StartupLab fue destacada como "App del Mes" en Play Store Colombia.', 'fecha_obtencion' => '2023-09-01', 'url_credencial' => null,                               'identificador' => null,         'visibilidad' => 'publico', 'eliminado' => false, ],
