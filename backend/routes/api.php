...
// NOTA: ProyectoController fue eliminado de las rutas — su lógica está
// consolidada en PortafolioController (rutas /portafolio/proyectos).
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Catálogo de habilidades (solo lectura, sin auth podría abrirse si se necesita)
    Route::get('/catalogo/habilidades', [HabilidadController::class, 'catalogo']);

    // Actualización de nivel de habilidad del usuario (usada por ModalEditarHabilidad)
