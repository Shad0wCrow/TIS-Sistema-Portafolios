...
export default function AdminUsuariosReportados() {
  ...
  function handleEstadoChange(value: "todos" | "activos" | "inhabilitados") { setEstado(value); setPage(1); }
  function handleRolChange(value: string) { setRol(value); setPage(1); }
      ...
      <main className="admin-main">
        ...
        <section className="admin-section admin-users-shell">
          ...
          <div className="admin-section-header">
            ...
            <div className="admin-users-head-actions">
              <button
                ...
                onClick={() => { void loadUsers(); void loadSummary(); }}
              >
                ↺ Actualizar
              </button>
            </div>
          ...
          <div className="admin-users-layout">
            ...
            {/* Table zone — overflow:hidden keeps the scrollable table from pushing the sidebar */}
            <div className="admin-users-table-zone">
              ...
              {lastPage > 1 && (
                <div className="admin-pagination">
                  ...
                  <button
                    type="button"
                    onClick={() => setPage((c) => Math.min(lastPage, c + 1))}
            ...
            <aside className="admin-users-sidebar">
              ...
              <article className="admin-report-card admin-users-note">
                ...
                <p className="admin-empty-text">
                  La vista abre por defecto con usuarios inhabilitados para revisar
                  primero los casos más delicados.
                </p>
              </article>
