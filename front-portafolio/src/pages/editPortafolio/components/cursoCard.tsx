...
export default function CursoCard({ cursos, onAdd, onRemove }: CursoCardProps) {
  return (
    <div className={styles.card}>
      ...
      {cursos.length === 0 ? (
        <div className={styles.emptyState}>
          ...
          <p className={styles.emptySubText}>Agrega cursos, certificaciones o talleres que hayas completado.</p>
        </div>
      ) : (
            ...
            return (
              <li key={curso.id_educacion} className={styles.item}>
                ...
                <div className={styles.itemInfo}>
                  ...
                  {esActual && (
                    <span className={styles.badgeActual}>En curso</span>
                  )}
                  {curso.descripcion && (
                ...
                <div className={styles.itemActions}>
                  <span className={`${styles.badge} ${curso.visibilidad === "publico" ? styles.badgePublic : styles.badgePrivate}`}>
